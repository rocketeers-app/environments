...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Queued broadcasts are pushed onto their own queue so that a backlog of
    | slow application jobs never delays a real-time update. A dedicated
    | worker should be listening on this queue next to the default one.
    |
    */
