export default function AWSIcon({
    ...
    const fillColor = !isDark ? '#000' : '#fff';

    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlSpace="preserve"
            viewBox="0 102.6 511.9 306.4"
            {...props}
            className={className}
        >
