export default function PlausibleIcon({
    className,
    ...props
    ...
    return (
        ...
        >
            ...
            <path
                ...
                fill="url(#plausible-icon-gradient-a)"
            />
            <path
                ...
                fill="url(#plausible-icon-gradient-b)"
            />
        </svg>
    );
}
