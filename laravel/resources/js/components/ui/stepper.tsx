    ...
    (props, ref) => {
        ...
        const renderStep = () => {
            switch (isVertical) {
                case true:
                    return (
                        <VerticalStep ref={ref as React.Ref<HTMLDivElement>} {...sharedProps}>
                            {children}
                        </VerticalStep>
                    )
                default:
                    return <HorizontalStep ref={ref as React.Ref<HTMLDivElement>} {...sharedProps} />
            }
        }
    ...
    (props, ref) => {
        ...
        return React.useMemo(() => {
            ...
            if (isCurrentStep) {
                ...
                if (isLoading) {
                    return (
                        <Spinner className={cn(iconVariants({ size }), '')} />
                    )
                }
            }
            if (Icon) {
